 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Provides two methods: 1. getOpposite() returns the logical inverse. 2. getOffset() returns a Coordinate object representing the direction's unit offset.
 * 1. getOpposite(): > Returns the logical inverse direction.
 * Mapping: {UP ↔ DOWN, LEFT ↔ RIGHT}.
 * Implementation: Use a switch-case statement. Throw IllegalStateException for unknown values.
 * 
 * 2. getOffset(): > Returns a unit offset as a util.Coordinate object using grid-based logic.
 * Mapping (row, col): > - UP: (-1, 0)
 * 
 * DOWN: (1, 0)
 * 
 * LEFT: (0, -1)
 * 
 * RIGHT: (0, 1)
 * Requirement: Must return a new instance of Coordinate.
 * <!-- end-model-doc -->
