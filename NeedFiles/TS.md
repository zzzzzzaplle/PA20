...
---
+ Test Case 6: "Single Course with Enrollment and Quota Change" 
    Input: "An Instructor object with a single course having an initial quota of 20. One Student enrolls in this course. Subsequently, the instructor increases the quota of this course by 5."
    Expected Output: "The remaining quota should be 24. (Calculation: Initial 20 - 1 Enrolled + 5 Increase = 24)."
```
